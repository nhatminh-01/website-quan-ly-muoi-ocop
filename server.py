...
ASSET_FILES = {
    ...
    "/assets/dashboard-header.webp": ("dashboard-header.webp", "image/webp"),
    ...
    if session:
        ...
        <header class="site-header">
          ...
          <a class="brand-link" href="/dashboard">
            <img class="brand-emblem" src="/assets/LOGO-CCPTNT-TP.HCM_.jpg?v=20260918-ccptnt" alt="Logo Chi cục Phát triển nông thôn Thành phố Hồ Chí Minh" width="56" height="58">
        ...
        <aside class="sidebar" id="site-sidebar" aria-label="Menu chính">
          ...
          <div class="sidebar-footer"><img class="sidebar-watermark" src="/assets/LOGO-CCPTNT-TP.HCM_.jpg?v=20260918-ccptnt" alt="" width="148" height="152"><div class="sidebar-footer-line"></div><strong><span>TRUNG TÂM CHUYỂN ĐỔI SỐ</span><span>NÔNG NGHIỆP VÀ MÔI TRƯỜNG</span></strong><p>Theo dõi sản xuất và tổng hợp báo cáo các đơn vị.</p></div>
        </aside>
...
def login_page(message=""):
    ...
    <div class="login-wrap"><div class="login">
      <img class="login-emblem" src="/assets/LOGO-CCPTNT-TP.HCM_.jpg?v=20260918-ccptnt" alt="Logo Chi cục Phát triển nông thôn Thành phố Hồ Chí Minh" width="70" height="72">
