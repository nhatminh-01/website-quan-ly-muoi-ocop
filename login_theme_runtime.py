...
.login-v11-contact{position:absolute;z-index:2;left:0;right:0;bottom:0;min-height:17.5%;padding:18px clamp(28px,4vw,68px) 20px;display:flex;flex-direction:column;justify-content:center;color:#fff;background:linear-gradient(90deg,rgba(5,105,52,.98) 0%,rgba(5,105,52,.94) 50%,rgba(5,105,52,.72) 72%,rgba(5,105,52,.42) 88%,rgba(5,105,52,.18) 100%);box-shadow:0 -1px 0 rgba(255,255,255,.12)}
.login-v11-contact::before{content:"";position:absolute;left:0;right:0;top:-24px;height:25px;background:linear-gradient(90deg,rgba(7,111,55,.96) 0%,rgba(7,111,55,.88) 52%,rgba(7,111,55,.60) 78%,rgba(7,111,55,.22) 100%);clip-path:polygon(0 48%,100% 0,100% 100%,0 100%);pointer-events:none}
...
@media(max-width:760px){.login-v11-contact{min-height:112px;padding:12px 16px 13px;background:linear-gradient(90deg,rgba(5,105,52,.98) 0%,rgba(5,105,52,.94) 72%,rgba(5,105,52,.82) 100%)}.login-v11-contact::before{top:-13px;height:14px}.login-v11-contact-title{margin-bottom:7px;font-size:11px}.login-v11-contact-list{grid-template-columns:1fr 1fr;gap:5px 12px}.login-v11-contact-item{font-size:9px;gap:6px}.login-v11-contact-item:first-child{grid-column:1/-1}.login-v11-contact-item svg{width:13px;height:13px;flex-basis:13px}}
    ...
    page = f'''{style}<main class="login-v11-shell">
      <section class="login-v11-visual" aria-label="Nhận diện Chi cục Phát triển nông thôn">
        ...
        <div class="login-v11-contact" aria-label="Thông tin liên hệ Chi cục Phát triển nông thôn Thành phố Hồ Chí Minh">
          ...
          <ul class="login-v11-contact-list">
            <li class="login-v11-contact-item"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m3 11 9-8 9 8"/><path d="M5 10v10h14V10M9 20v-6h6v6"/></svg><span>56 58 Bạch Đằng, Phường Bình Thạnh, Thành phố Hồ Chí Minh</span></li>
      ...
      <section class="login-v11-panel" aria-labelledby="login-v11-heading">
        ...
        <footer class="login-v11-footer">
          <div class="login-v11-maker"><svg viewBox="0 0 32 42" aria-hidden="true"><path d="M16 39V14m0 13C4 29 2 20 3 15c8 0 13 5 13 12Zm0 5c12 1 14-7 13-12-8 0-13 5-13 12ZM16 3c-11 8-9 14 0 18 9-4 11-10 0-18Zm-8 18 5 4m11 1-5 4"/></svg><div><small>Đơn vị phát triển và vận hành</small><strong>Trung tâm Chuyển đổi số Nông nghiệp và Môi trường</strong></div></div>
